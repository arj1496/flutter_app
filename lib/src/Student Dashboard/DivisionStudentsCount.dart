...
class DivisionStudentsCount extends StatelessWidget {
  String title;
  DivisionStudentsCount({
    this.title,
});

  @override
  Widget build(BuildContext context) {
    return divisionStudentsCount();
  }

  Widget divisionStudentsCount() {
    return Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(
                          "Division Name",
                         // gradeDetailsMap['gardeName'].toString(),//"ClassName",
