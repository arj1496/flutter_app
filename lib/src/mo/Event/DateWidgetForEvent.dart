...
class DateWidgetForEvent extends StatefulWidget {
  ...
  DateWidgetForEvent.init(formKey, _eventPojo) {
    this.formKey = formKey;
    this.event = _eventPojo;
  }
}

class HWAddUIState extends State<DateWidgetForEvent>{
  ...
  @override
  void initState() {
    if(widget.event!= null && widget.event.startDate != null && widget.event.endDate !=null){
      _startDate = new DateTime.fromMicrosecondsSinceEpoch(widget.event.startDate );
      _endDate = new DateTime.fromMicrosecondsSinceEpoch(widget.event.endDate );
      widget.event.startDate = widget.event.startDate ;
      widget.event.endDate = widget.event.endDate ;
    }
  }
  HWAddUIState.init(){}
  ...
  _selectEndDate(BuildContext context) async{
    ...
    if(dateTime != null && dateTime != _endDate){
      ...
      setState(() {
        ...
        widget.event.endDate = dateTime.millisecondsSinceEpoch;
      });
    }
  }
  ...
  _selectDate(BuildContext context) async{
    ...
    if(dateTime != null && dateTime != _startDate){
      ...
      setState(() {
        _startDate = dateTime;
        widget.formKey.currentState.save();
        widget.event.startDate = dateTime.millisecondsSinceEpoch;
  ...
  _selectTime(BuildContext context) async{
    ...
    if(time != null && time != _pickedTime){
      ...
      setState(() {
        ...
        widget.formKey.currentState.save();
       // widget.event.duration = time.minute;
      });
    }
  }
