...
import 'package:flutter_app/src/mo/Attendance/AttendanceCalendar/calendarDesign/WeekDayRow.dart';
import 'package:flutter_app/src/mo/Attendance/AttendanceCalendar/calendarDesign/calendarHeader.dart';
import 'package:flutter_app/src/mo/Attendance/AttendanceCalendar/calendarDesign/defaultStyle.dart';
import 'package:flutter_app/src/mo/Attendance/AttendanceCalendar/classes/Event.dart';
import 'package:flutter_app/src/mo/Attendance/AttendanceCalendar/classes/EventList.dart';
import 'package:flutter_app/src/mo/Attendance/StudentListPage.dart';

import 'package:intl/date_symbol_data_local.dart';
import 'package:intl/intl.dart' show DateFormat;
export 'package:flutter_app/src/mo/Attendance/AttendanceCalendar/classes/EventList.dart';
...
class _CalendarState<T extends EventInterface> extends State<CalendarCarousel<T>> {
  ...
  void _onDayLongPressed(DateTime picked) {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context)=>StudentUIList(picked)));
  }
