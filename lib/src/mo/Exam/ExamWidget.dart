    ...
    return  Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                getTimeBoxUI("24", "Marks",8,4),
                getTimeBoxUI("2:20 PM", "Time",4,4),
                getTimeBoxUI("21 Oct ", "Date",4,8),
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        padding: const EdgeInsets.only(bottom:8.0,right:2.0,left:16),
                                        child: Text(
                                          'Unit Test 1 ',
