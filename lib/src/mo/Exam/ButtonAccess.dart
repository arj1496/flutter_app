...
class ButtonAccess extends StatelessWidget {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              getButtonUI(CategoryType.ui, categoryType == CategoryType.ui,true),
              SizedBox(
                width: 16,
              ),
              getButtonUI(
                  CategoryType.coding, categoryType == CategoryType.coding, false),
              SizedBox(
                width: 16,
              ),
              getButtonUI(
                  CategoryType.basic, categoryType == CategoryType.basic,true),
            ],
          ),
        ),
        SizedBox(
  ...
  Widget getButtonUI(CategoryType categoryTypeData, bool isSelected,bool val) {
    var txt = '';
